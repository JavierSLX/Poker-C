...
![GrafoCT](./images/grafoComprobarTrio.png)  

Los elementos que representan los nodos son los siguientes:  
1. ***i = 0***. Inicializa el contador a 0.  
2. ***if (trio)***. Checa si encuentra un trio en la mano.  
...
- **03/12/16**. Se probó la función hasta encontrar mínimo un trio, lo que al final se obtuvo un resultado ***EXITOSO ✔***.  

![pruebaCT](./images/pruebaComprobarTrio.png) 